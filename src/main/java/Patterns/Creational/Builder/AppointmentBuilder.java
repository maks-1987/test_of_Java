...
/**
 * AppointmentBuilder - основа шаблона, управляет созданием комплексного продукта,
 * представленным объектом Appointment.
 */
/*
public class AppointmentBuilder {
    ...
    public Appointment getAppointment() InformationRequiredException {
        requiredElements = 0;
